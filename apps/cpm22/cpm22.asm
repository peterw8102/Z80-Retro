...
;**************************************************************
; Export CBASE
				EXTRN  WBOOT,CONST,CONIN,CONOUT,LIST,PUNCH,READER,HOME,SELDSK,SETTRK,SETSEC,SETDMA
        EXTRN  READ,WRITE,SECTRN
				PUBLIC CCP,BDOS,CBASE,FBASE,INBUFF,COMMAND,CMMND1,RSTDSK,NXENTRY,DOREAD,DOWRITE

        PUBLIC DIRECT,GETFST
...
DEL	EQU	7FH		;rubout
;
;   Set origin for CP/M - using rel so calculate this later! This is the start of CPP for CP/M 2
;
  CSEG
;
CCP:
...
INBUFF:	DEFB	127		;length of input buffer.
	...
	DEFB	'Copyright'
	DEFB	' 1981 (c) by Digital Research      '
...
;*
;**************************************************************
; Define labels for the BIOS jump table. BIOS is located immediately AFTER BDOS
