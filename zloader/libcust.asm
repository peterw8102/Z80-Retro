; PROJECT/BUILD SPECIFIC DEFINITIONS
...
; The SIO library includes a receive ISR for port A. This can be built
; as either a direct ISR that can be installed at 38h OR as a library
; function called from code at 38h. In the second case the ISE code
; relies on the caller to re-enable interrupts and execute the RETI
; instruction.
SIO_ISR         .EQU    1h        ; Don't include EI/RETI code
